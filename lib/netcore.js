...
Netcore.prototype.permitJoin = function (duration, callback) {  // callback is optional
    var self = this,
        permitJoin = this._drivers.net.permitJoin,
        cb;
...
Netcore.prototype.remove = function (permAddr, callback) {
    var self = this,
        remove = this._drivers.net.remove,
        ncName = this.getName(),
