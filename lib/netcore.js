    ...
    return {
        ...
        traffic: {
            in: {
                ...
                kbytes: this._getRxKB,
            },
            out: {
                hits: this._traffic.out.hits,
                kbytes: this._getTxKB,
            }
        }
    };
};
