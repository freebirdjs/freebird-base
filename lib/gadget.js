...
function Gadget(dev, auxId, rawGad) {
    ...
    _attrs = {};       // other kvps from remote gadget

    Object.defineProperty(this, '_id', _.assign({ value: null }, propSetting1));
    Object.defineProperty(this, '_auxId', _.assign({ value: auxId }, propSetting1));
    Object.defineProperty(this, '_dev', _.assign({ value: dev }, propSetting1));
    Object.defineProperty(this, '_raw', _.assign({ value: rawGad }, propSetting1));     // optional

    Object.defineProperty(this, '_panel', _.assign({ value: _panel }, propSetting2));
...
function anyEnableError(gad) {
    ...
    else if (!gad.get('device').isEnabled())
