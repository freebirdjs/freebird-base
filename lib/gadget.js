    ...
    switch (name) {
        ...
        case 'panel':               // setPanelInfo
            ...
            if (!_.isEmpty(delta)) {
                ...
                this._fire(EVTS.GadPanelChanged, { data: delta, _data: oldData });
            }
            break;
        case 'props':               // setProps
            ...
            if (!_.isEmpty(delta)) {
                ...
                this._fire(EVTS.GadPropsChanged, { data: delta, _data: oldData });
            }
            break;
        case 'attrs':               // setAttrs
            ...
            if (!_.isEmpty(delta)) {
                ...
                this._fire(EVTS.GadAttrsChanged, { data: delta, _data: oldData });
            }
            break;
        default:
            break;
...
Gadget.prototype.read = function (attrName, callback) {
    ...
    read(permAddr, auxId, attrName, function (err, data) {
        ...
        if (!err) {
            ...
            self._fire(EVTS.GadRead, { permAddr: permAddr, auxId: auxId, data: result });
        }
...
Gadget.prototype.write = function (attrName, val, callback) {
    ...
    write(permAddr, auxId, attrName, val, function (err, data) {
        ...
        if (!err) {
            ...
            self.set('attrs', result);
            self._fire(EVTS.GadWrite, { permAddr: permAddr, auxId: auxId, data: result });
        }
...
Gadget.prototype.exec = function (attrName, args, callback) {
    ...
    exec(permAddr, auxId, attrName, args, function (err, data) {
        ...
        if (!err) {
            result =  _.set({}, attrName, data); 
            self._fire(EVTS.GadExec, { permAddr: permAddr, auxId: auxId, data: result });
        }
...
Gadget.prototype.readReportCfg = function (attrName, callback) {
    ...
    readReportCfg(permAddr, auxId, attrName, function (err, data) {
        ...
        if (!err) {
            result = _.set({}, attrName, data);
            self._fire(EVTS.GadReadReportCfg, { permAddr: permAddr, auxId: auxId, data: result });
        }
...
Gadget.prototype.writeReportCfg = function (attrName, cfg, callback) {
    ...
    writeReportCfg(permAddr, auxId, attrName, cfg, function (err, data) {
        ...
        if (!err) {
            result =  _.set({}, attrName, data); 
            self._fire(EVTS.GadWriteReportCfg, { permAddr: permAddr, auxId: auxId, data: result });
        }
...
Gadget.prototype._fire = function (evt, data) {
