...
Gadget.prototype.set = function (propName, arg) {
    ...
    switch (propName) {
        case '_id':     // _setId, protected
            ...
            this._id = arg;     // arg = id
            this.get('dev')._connectGadIdToAuxId(arg, this.get('auxId'));
            break;
        case '_dev':
            validate.device(arg);
        ...
        case 'panel':           // setPanelInfo
            validate.object(arg, 'Input info should be an object');
            ...
            break;
        case 'props':           // setProps
            validate.object(arg, 'Input props should be an object');
            delta = utils.getObjectDiff(arg, this.get('props'));  // arg = props
            ...
            break;
        case 'attrs':           // setAttrs
            validate.object(arg, 'Input attrs should be an object');
            delta = utils.getObjectDiff(arg, this.get('attrs'));  // arg = attrs
