...
Device.prototype.get = function (propName, arg) {
    var result;
    validate.string(propName, 'propName should be a string.');
...
Device.prototype.set = function (propName, arg) {
    ...
    switch (propName) {
        case '_id':     // _setId, protected
            validate.stringOrNumber(arg, '_id should be a number or a string.');
            this._id = arg;     // arg = id
            break;
        case '_raw':    // _setRawDev
            ...
            break;
        case 'net':     // setNetInfo
            validate.object(arg, 'info should be an object');
            ...
            break;
        case 'props':   // setProps
            validate.object(arg, 'props should be an object');
            ...
            break;
        case 'attrs':   // setAttrs
            validate.object(arg, 'attrs should be an object');
...
Device.prototype.ping = function (callback) {
    ...
    // ping driver is on net
    return this._netcore.ping(this.get('permAddr'), callback);
};
