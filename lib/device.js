...
Device.prototype.enable = function () {
    ...
    this._fbEmit(DEV_EVT.netChanged, {   // or _fbEmit() will be blocked
        data: { enabled: true }
    });
    return this;
};
...
Device.prototype.disable = function () {
    ...
    this._fbEmit(DEV_EVT.netChanged, {   // should emit first then change enabled to false,
...
Device.prototype.setNetInfo = function (info) {
    ...
    if (!_.isEmpty(delta))
        this._fbEmit(DEV_EVT.netChanged, { data: delta });
...
Device.prototype.setProps = function (props) {
    ...
    if (!_.isEmpty(delta)) {
        ...
        this._fbEmit(DEV_EVT.propsChanged, { data: delta });
    }
    return this;
};
...
Device.prototype.setAttrs = function (attrs) {
    ...
    if (!_.isEmpty(delta)) {
        ...
        this._fbEmit(DEV_EVT.attrsChanged, { data: delta });
    }
    return this;
};
...
Device.prototype.resetTxTraffic = function () {
    ...
    this._fbEmit(DEV_EVT.netChanged, {   // only report@reset
        data: {
...
Device.prototype.refresh = function (callback) {
    ...
    if (!this.isEnabled()) {
        ...
        this._fbEmit(DEV_EVT.error, { error: err });
        return callback(err);
    }
